(function (e) {
	...
	s.p = "https://cdn.jsdelivr.net/gh/savemydinar/esmailtv2@2.0.22/dist/",
	s.oe = function (e) {
	...
	"56d7": function (e, t, a) {
		...
		l = {
			...
			data: function () {
				return {
					github: "https://github.com/savemydinar/esmailtv2"
				}
			},
			watch: {
	...
	"9bd2": function (e, t, a) {
		...
		c = r.a.create({
				baseURL: Object({
					...
					VUE_APP_CDN_PATH: "https://cdn.jsdelivr.net/gh/savemydinar/esmailtv2@2.0.22/dist/",
					VUE_APP_VERSION: "2.0.8",
					VUE_APP_G2INDEX_VERSION: "1.1.2",
					BASE_URL: "https://cdn.jsdelivr.net/gh/savemydinar/esmailtv2@2.0.22/dist/"
				}).VUE_APP_API ? Object({
					NODE_ENV: "production",
					VUE_APP_I18N_LOCALE: "zh-chs",
					VUE_APP_I18N_FALLBACK_LOCALE: "en",
									...
									staticClass: "field is-grouped is-grouped-multiline"
											...
											staticClass: "control"
													...
													staticClass: "tags has-addons"
															...
															attrs: {
																href: "https://github.com/savemydinar/esmailtv2"
															}
	...
	cbd9: function (e, t, a) {
		"use strict";
		function n(e) {
			var t = "https://cdn.jsdelivr.net/gh/savemydinar/esmailtv2@2.0.22/dist/";
			return t + e
		}
		a.d(t, "a", (function () {
				return n
